...
exports.generateQR = async (req, res) => {
  ...
  const data = {
    QRCRawData1:
      '100020101021151450015ID.OR.GPNQR.WWW0215ID10190000000990303UME520458125303360540810000.005502015802ID5921BAKSO MALANG MAS NANO6013JAKARTA PUSAT61051034062140710A000000001630439ED',
    QRCRawData2:
      '200020101021151450015ID.OR.GPNQR.WWW0215ID10190000000990303UME520458125303360540810000.005502015802ID5921BAKSO MALANG MAS NANO6013JAKARTA PUSAT61051034062140710A000000001630439ED',
  };
  ...
  try {
    ...
    res.json({ message: 'QR Code successfully generated' });
  } catch (error) {
